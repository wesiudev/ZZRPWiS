...
export default function Hero() {
  ...
  return (
    <>
      <main
        ref={mainWrapper}
        className="h-full flex min-h-[50vh] flex-col items-center justify-between p-4 md:p-8 lg:p-12 xl:p-16 2xl:p-24 bg-heroBG bg-center relative"
      >
        <div className="absolute -bottom-[50vh] left-0"></div>
        <Image
          src="/assets/logo.jpg"
          width={256}
          height={256}
