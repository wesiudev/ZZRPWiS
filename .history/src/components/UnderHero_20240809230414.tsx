  ...
  return (
    ...
    >
      <div className="p-6 lg:p-12 xl:p-16 2xl:p-24">
        ...
        osobistego (nie z konta prowadzonej działalności gospodarczej) lub b) za
        pośrednictwem przekazu pocztowego – jedna osoba może wpłacić maksymalnie
        jednorazowo 2250 zł, na rachunek: 11 1111 1111 1111 1111 1111 1111
        Związek Zawodowy Rolnictwa Polskiego Wolni i Solidarni   Władysława Iv
        12E / 6, 80-547 Gdańsk, Polska Tytuł przelewu: „Darowizna na ZZRPWiS”
        Zsumowane wpłaty nie mogą przekroczyć 33 750 zł na osobę w ciągu roku
        kalendarzowego.
      </div>
    </motionDiv.div>
  );
