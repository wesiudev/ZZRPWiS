      ...
      <div className="p-6 lg:p-12 xl:p-16 2xl:p-24">
        <div className="flex flex-col items-center justify-center 2xl:flex-row 2xl:space-x-12 mb-12">
          <div className="flex flex-col items-center">
            <div className="mb-6 lg:mb-12 xl:mb-16 2xl:mb-24 p-6 rounded-full border-[3px] bg-green-500 border-green-700 aspect-square w-32 h-32 xl:w-36 xl:h-36  flex items-center justify-center">
