    ...
    >
      <div className="p-6 lg:p-12 xl:p-16 2xl:p-24">
        ...
        <div className="text-zinc-800 mt-12">
          <h2 className="font-bold text-5xl">Wesprzyj ZZRPWiS:</h2> <br />
          <p className="text-gray-500 mt-6 text-lg lg:text-xl text-justify">
      ...
      <div className="flex flex-row flex-wrap space-x-3 text-zinc-800 mt-4 w-full justify-center">
