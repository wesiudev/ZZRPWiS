...
export default function Hero() {
  return (
    <main className="flex min-h-[50vh] flex-col items-center justify-between p-4 md:p-8 lg:p-12 xl:p-16 2xl:p-24 bg-heroBG bg-bottom relative">
      <Image
        src="/assets/logo.jpg"
        width={256}
        height={256}
      ...
      <div className="relative z-10 flex flex-col">
        <p className="text-2xl text-white font-cardo font-bold mt-12">
