...
export default function Hero() {
  ...
  return (
    <>
      <main className="h-full flex min-h-[50vh] flex-col items-center justify-between p-4 md:p-8 lg:p-12 xl:p-16 2xl:p-24 bg-heroBG bg-center bg-no-repeat relative">
        <div
          ref={mainWrapper}
