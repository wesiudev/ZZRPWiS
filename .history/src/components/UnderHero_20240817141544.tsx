  ...
  return (
    ...
    >
      <div className="p-6 lg:p-12 xl:p-16 2xl:p-24">
        <div className="flex flex-col items-start justify-center 2xl:flex-row 2xl:space-x-12 mb-12">
          <div className="flex flex-col items-center">
            <div className="mb-6 lg:mb-12 xl:mb-16 p-6 rounded-full border-[3px] bg-green-500 border-green-700 aspect-square w-32 h-32 lg:w-36 lg:h-36 xl:w-40 xl:h-40 2xl:w-52 2xl:h-52 flex items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-start mt-12 2xl:mt-0">
            <div className="mb-6 lg:mb-12 xl:mb-16 p-6 rounded-full border-[3px] bg-green-500 border-green-700 aspect-square w-32 h-32 lg:w-36 lg:h-36 xl:w-40 xl:h-40 2xl:w-52 2xl:h-52 flex items-center justify-center">
              <BsMegaphone className="text-white text-5xl lg:text-6xl xl:text-7xl" />
            </div>
            <p
              style={{ lineHeight: 1.35, textShadow: "1px 1px 3px gray" }}
              className="mx-auto text-center font-cardo text-zinc-800 font-bold text-2xl sm:text-4xl 2xl:text-5xl max-w-[40rem]"
