...
export default async function Page() {
  return (
    <>
      ...
      <div className="relative my-12 bg-heroBG min-h-screen w-full bg-center bg-no-repeat">
        <div className="flex items-center justify-center fixed h-full w-full left-0 top-0 bg-black bg-opacity-70" />
