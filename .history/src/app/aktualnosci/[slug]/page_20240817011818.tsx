      ...
      <div className="px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32 pt-12 pb-24 bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mx-auto">
          <div className="flex flex-col">
            ...
            {product?.text2Title && (
              <h2 className="text-2xl font-bold mt-12 drop-shadow-xl shadow-black text-zinc-800 ">
                {product?.text2Title}
              </h2>
            )}
            {product?.text2Desc && (
          ...
          <div className="flex flex-col">
            ...
            {product?.text3Title && (
              <h2 className="text-2xl font-bold mt-6 drop-shadow-xl shadow-black text-zinc-800 ">
                {product?.text3Title}
              </h2>
            )}
            {product?.text3Desc && (
