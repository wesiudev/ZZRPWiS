  ...
  return (
    <>
      ...
      <div className="px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32 pt-12 pb-24 bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-12 xl:gap-16 2xl:gap-24 mx-auto">
          ...
          <div className="flex flex-col">
            ...
            {product?.text3Title && (
              <h2 className="text-3xl font-bold mt-12 drop-shadow-xl shadow-black text-zinc-800 mb-4">
                {product?.text3Title}
              </h2>
            )}
            {product?.text3Desc && (
      ...
      <div className="bg-white pb-12">
        {product?.secondaryImage !== "" &&
          product?.text4Title !== "" &&
          product?.text4Desc !== "" && (
            <div className="pt-24 grid grid-cols-1 lg:grid-cols-2 px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32 gap-4">
              <div
                style={{ boxShadow: "0px 0px 5px #000000" }}
      ...
      <div className="py-24 pl-4 md:pl-8 lg:pl-12 xl:pl-20 2xl:pl-32 pb-24 w-full bg-white">
